...
while True:
    ...
    alibaba = df2.loc[df2['Идентиф. Код ЦБ', 'Идентиф. Код ЦБ'] == 'MRNA']
    ...
    url = r'https://www.londonstockexchange.com/market-stock/0A45/moderna-inc/overview'
    ...
    url = r'https://ru.investing.com/equities/moderna?cid=1172691'
    ...
    if (cnt >= 3):
        ...
        df.to_csv('mdrn.csv', mode='a', index=False, header=False)
