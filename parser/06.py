...
while True:
    ...
    alibaba = df2.loc[df2['Идентиф. Код ЦБ', 'Идентиф. Код ЦБ'] == 'NVDA']
    ...
    url = r'https://www.londonstockexchange.com/market-stock/0R1I/nvidia-corp/overview'
    ...
    url = r'https://ru.investing.com/equities/nvidia-corp?cid=1165943'
    ...
    if (cnt >= 3):
        ...
        df.to_csv('nvda.csv', mode='a', index=False, header=False)
