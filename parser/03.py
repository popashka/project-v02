...
while True:
    ...
    alibaba = df2.loc[df2['Идентиф. Код ЦБ', 'Идентиф. Код ЦБ'] == 'BABA']
    ...
    url = r'https://www.londonstockexchange.com/market-stock/0HCI/alibaba-group-holding-ltd/overview'
    ...
    url = r'https://ru.investing.com/equities/alibaba?cid=1167268'
    ...
    if (cnt >= 3):
        ...
        df.to_csv('baba.csv', mode='a', index=False, header=False)
