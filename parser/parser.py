...
url = 'https://www.boerse-frankfurt.de/en/etf/21shares-bitcoin-etp'
url2 = 'https://www.boerse-stuttgart.de/de-de/produkte/etps/etns/stuttgart/a2t64e-21shares-bitcoin-abtc-etp'
url3 = 'https://www.bxswiss.com/instruments/CH0454664001'
url4 = 'https://www.six-group.com/en/products-services/the-swiss-stock-exchange/market-data/etp/etp-explorer/etp-detail.CH0454664001EUR4.html#/'
...
while(1 < 2):
    ...
    df.to_csv('pars.csv', mode='a', index=False, header=False)
