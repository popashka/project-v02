...
pyplot.plot(pmsc, 'b', label='msc price')
pyplot.plot(pldn, 'r', label='ldn price')
pyplot.plot(ppit, 'g', label='pit price')
#pyplot.ylim(ymax = 40, ymin = -20)
pyplot.title('lukoil prices')
pyplot.legend()
pyplot.show()

print(df)

#df.to_csv('luk-an.csv', mode='a', index=False, header=False)
